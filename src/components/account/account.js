...
class account extends React.Component {
	componentWillMount() {
		...
		console.log("-=-=faqId-=",accountId);
		let formData = {id:accountId}
		this.props.AC_VIEW_USER(formData);
	}
	render() {		
		const name= this.props.accountReducer.accountInfo.name;
		const email= this.props.accountReducer.accountInfo.email;
		const mobile= this.props.accountReducer.accountInfo.mobile;
		const gender= this.props.accountReducer.accountInfo.gender;
		return (
			<div class="main-body">
